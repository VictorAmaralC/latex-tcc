...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.2]{figuras/desenvolvimento/dataPreparation.eps}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.25]{figuras/desenvolvimento/dataPrepCentralized.eps}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.2]{figuras/desenvolvimento/CodeFederatedLearning.eps}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.2]{figuras/desenvolvimento/centralizedModel.eps}
